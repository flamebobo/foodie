...
public class CenterUserController extends BaseController {
    ...
    public FlameJSONResult uploadFace(
...
//        String fileSpace = IMAGE_USER_FACE_LOCATION;
        ...
        if (file != null) {
            ...
            try {
                ...
                if (StringUtils.isNotBlank(fileName)) {
                    ...
                    // 文件重命名  flame-face.png -> ["flame-face", "png"]
                    ...
                    if (!suffix.equalsIgnoreCase("png") &&
                        ...
                        return FlameJSONResult.errorMsg("图片格式不正确！");
                    }
            ...
            return FlameJSONResult.errorMsg("文件不能为空！");
        }
    ...
    @PostMapping("update")
    public FlameJSONResult update(
            @ApiParam(name = "userId", value = "用户id", required = true)
            @RequestParam String userId,
            @RequestBody @Valid CenterUserBO centerUserBO,
            BindingResult result,  // 错误信息都会在这里获取
            HttpServletRequest request, HttpServletResponse response) {
        ...
        if (result.hasErrors()) {
            ...
            return FlameJSONResult.errorMap(errorMap);
        }
