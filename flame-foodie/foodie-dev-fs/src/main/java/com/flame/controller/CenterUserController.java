...
import com.flame.resourse.FileResource;
import com.flame.service.FdfsService;
        ...
        if (file!=null) {
            ...
            if (StringUtils.isNotBlank(fileName)) {
                ...
                if (!suffix.equalsIgnoreCase("png") &&
                    ...
                    return FlameJSONResult.errorMsg("图片格式不正确！c");
                }
...
//            String finalUserFaceUrl = fileResource.getHost() + path;
            ...
            return FlameJSONResult.errorMsg("上传头像失败");
        }
