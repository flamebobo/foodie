...
//        FileSystem fs = FileSystem.get(new URI("hdfs://pccw107:8020"), configuration,"root");
//
//        // 2 创建目录
...
//    }
    ...
    public void init() throws URISyntaxException, IOException, InterruptedException {
        // 连接的集群nn地址
        URI uri = new URI("hdfs://pccw107:8020");
        // 创建一个配置文件
        Configuration configuration = new Configuration();
    ...
    public void testPut() throws IOException {
        ...
        fs.copyFromLocalFile(false, true, new Path("D:\\sunwukong.txt"), new Path("hdfs://pccw107/xiyou/huaguoshan"));
    }
