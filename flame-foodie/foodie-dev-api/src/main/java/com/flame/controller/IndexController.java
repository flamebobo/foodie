...
import com.flame.pojo.Carousel;
import com.flame.pojo.Category;
import com.flame.pojo.vo.CategoryVO;
import com.flame.pojo.vo.NewItemsVO;
import com.flame.service.CarouselService;
import com.flame.service.CategoryService;
...
public class IndexController {
    ...
    @GetMapping("/carousel")
    public FlameJSONResult carousel() {
...
//        List<Category> list = categoryService.queryAllRootLevelCat();
    ...
    public FlameJSONResult subCat(
            @ApiParam(name = "rootCatId", value = "一级分类id", required = true)
            @PathVariable Integer rootCatId) {

        if (rootCatId == null) {
            return FlameJSONResult.errorMsg("分类不存在");
        }
    ...
    public FlameJSONResult sixNewItems(
            @ApiParam(name = "rootCatId", value = "一级分类id", required = true)
            @PathVariable Integer rootCatId) {
