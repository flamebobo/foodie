...
import com.flame.es.pojo.search.GeoBoundingBoxEntity;
...
public class ESMapController {
	...
	@ResponseBody
	public FlameJSONResult geoBoundingBox(
		...
		return FlameJSONResult.ok(userList);
	}
	...
	@ResponseBody
	public FlameJSONResult geoPolygon(
	...
	@ResponseBody
	public FlameJSONResult geoDistance(
	...
	@ResponseBody
	public FlameJSONResult addESPoint(@RequestBody User user) {
